...
description: "Network Manager via AWS CLI v2 (`aws networkmanager`). Global networks, core networks, sites, devices, links, connections, Transit Gateway, attachments, Connect peers, route analysis."
---
