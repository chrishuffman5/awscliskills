---
name: aws-lex
description: "Lex v2 via AWS CLI v2 (`aws lex`). Conversational AI bots, intents, slots, locales, custom vocabulary, import/export, test sets, analytics, runtime sessions."
---
