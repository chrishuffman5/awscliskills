...
description: "Personalize via AWS CLI v2 (`aws personalize`). ML recommendations, dataset groups, schemas, solutions, campaigns, recommenders, batch jobs, event trackers, runtime recommendations."
---
