---
name: aws-transfer
description: "Transfer Family via AWS CLI v2 (`aws transfer`). SFTP/FTPS/FTP/AS2 servers, users, access, connectors, agreements, workflows, host keys, certificates, web apps."
---
