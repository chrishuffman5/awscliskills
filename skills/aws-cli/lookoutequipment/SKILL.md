...
description: "Lookout for Equipment via AWS CLI v2 (`aws lookoutequipment`). Industrial equipment anomaly detection, datasets, models, inference schedulers, labels, retraining, sensor statistics."
---
