---
name: aws-iotdeviceadvisor
description: "IoT Device Advisor via AWS CLI v2 (`aws iotdeviceadvisor`). Suite definitions, suite runs, test reports, endpoint management."
---
