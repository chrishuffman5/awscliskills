---
name: aws-textract
description: "Textract via AWS CLI v2 (`aws textract`). Document text detection, form/table analysis, expense analysis, ID analysis, lending analysis, custom adapters."
---
