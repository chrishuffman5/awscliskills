...
description: "MediaPackage via AWS CLI v2 (`aws mediapackage`). Channel groups, channels, origin endpoints, harvest jobs, VOD packaging groups, configurations, assets."
---
