---
name: aws-backup
description: "Backup via AWS CLI v2 (`aws backup`). Backup plans, vaults, backup/copy/restore jobs, recovery points, frameworks, reports, restore testing, legal holds, Backup Gateway."
---
