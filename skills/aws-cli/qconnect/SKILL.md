---
name: aws-qconnect
description: "Q Connect via AWS CLI v2 (`aws qconnect`). AI-powered contact center assistant, knowledge bases, AI agents, guardrails, prompts, sessions, messaging, quick responses, message templates."
---
