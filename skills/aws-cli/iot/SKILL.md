---
name: aws-iot
description: "IoT Core via AWS CLI v2 (`aws iot`). Things, certificates, policies, rules, shadows, jobs, fleet indexing, security auditing, OTA updates, device defender, billing groups."
---
