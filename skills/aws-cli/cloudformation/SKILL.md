...
description: "CloudFormation via AWS CLI v2 (`aws cloudformation`). Stacks, change sets, stack sets, drift detection, resource scanning, type registry, generated templates."
---
