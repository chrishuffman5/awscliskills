---
name: aws-dms
description: "DMS via AWS CLI v2 (`aws dms`). Replication instances, endpoints, replication tasks, serverless replication, data migrations, migration projects, Fleet Advisor."
---
