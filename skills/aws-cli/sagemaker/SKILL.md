---
name: aws-sagemaker
description: "SageMaker via AWS CLI v2 (`aws sagemaker`). Training jobs, models, endpoints, processing, hyperparameter tuning, AutoML, pipelines, experiments, Feature Store, model registry, monitoring, notebooks, HyperPod clusters, Studio domains, MLflow, optimization, labeling, real-time/async inference."
---
