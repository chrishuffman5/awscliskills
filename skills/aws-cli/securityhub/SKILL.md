...
description: "Security Hub via AWS CLI v2 (`aws securityhub`). Hub management, findings, insights, standards, security controls, automation rules, configuration policies."
---
