...
description: "Application Auto Scaling via AWS CLI v2 (`aws application-autoscaling`). Scalable targets, scaling policies, scheduled actions, predictive scaling."
---
