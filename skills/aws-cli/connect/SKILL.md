---
name: aws-connect
description: "Connect via AWS CLI v2 (`aws connect`). Contact center instances, contact flows, contacts, users, queues, routing profiles, evaluation forms, metrics, cases, participant connections."
---
