---
name: aws-medialive
description: "MediaLive via AWS CLI v2 (`aws medialive`). Channels, inputs, input security groups, multiplexes, clusters, networks, schedules, reservations, signal maps."
---
