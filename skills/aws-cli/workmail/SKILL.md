---
name: aws-workmail
description: "WorkMail via AWS CLI v2 (`aws workmail`). Organizations, users, groups, resources, mail domains, access control, impersonation, mobile devices, message flow."
---
