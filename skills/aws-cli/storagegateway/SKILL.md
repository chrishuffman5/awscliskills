...
description: "Storage Gateway via AWS CLI v2 (`aws storagegateway`). Gateways, file shares (NFS/SMB), iSCSI volumes, tape gateway, cache, bandwidth, file system associations."
---
