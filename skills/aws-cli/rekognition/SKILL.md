...
description: "Rekognition via AWS CLI v2 (`aws rekognition`). Image/video analysis, face detection, collections, users, liveness, stream processors, media analysis, custom labels projects."
---
