...
description: "Global Accelerator via AWS CLI v2 (`aws globalaccelerator`). Accelerators, listeners, endpoint groups, custom routing, cross-account attachments, BYOIP."
---
