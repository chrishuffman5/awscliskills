---
name: aws-comprehend
description: "Comprehend via AWS CLI v2 (`aws comprehend`). NLP text analysis, entity detection, sentiment, key phrases, language detection, document classification, entity recognizers, flywheels, endpoints."
---
