...
description: "Organizations via AWS CLI v2 (`aws organizations`). Organization management, accounts, OUs, policies (SCPs, tag, backup, AI opt-out), handshakes, delegated admin."
---
