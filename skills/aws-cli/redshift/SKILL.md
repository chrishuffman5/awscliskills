---
name: aws-redshift
description: "Redshift via AWS CLI v2 (`aws redshift`). Provisioned clusters, snapshots, parameter groups, data sharing, Redshift Data API, Serverless namespaces/workgroups."
---
