...
description: "IAM Identity Center via AWS CLI v2 (`aws identity-center`). Instances, permission sets, account assignments, applications, trusted token issuers, identity store."
---
