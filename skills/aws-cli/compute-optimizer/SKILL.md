...
description: "Compute Optimizer via AWS CLI v2 (`aws compute-optimizer`). Resource optimization recommendations for EC2, EBS, Lambda, ASG, ECS, RDS, idle resources."
---
