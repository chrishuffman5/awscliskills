---
name: aws-kendra
description: "Kendra via AWS CLI v2 (`aws kendra`). Intelligent search indexes, data sources, FAQs, thesauri, query suggestions, featured results, experiences, intelligent ranking."
---
