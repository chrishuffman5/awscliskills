...
description: "Elastic Beanstalk via AWS CLI v2 (`aws elasticbeanstalk`). Applications, environments, versions, configuration templates, platforms, managed actions."
---
