---
name: aws-forecast
description: "Forecast via AWS CLI v2 (`aws forecast`). Time-series forecasting, datasets, AutoPredictors, forecasts, what-if analysis, explainability, monitors, queries."
---
