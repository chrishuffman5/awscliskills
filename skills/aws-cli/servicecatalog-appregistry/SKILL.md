---
name: aws-servicecatalog-appregistry
description: "Service Catalog AppRegistry via AWS CLI v2 (`aws servicecatalog-appregistry`). Applications, attribute groups, resource associations, configuration."
---
