---
name: aws-bedrock
description: "Bedrock via AWS CLI v2 (`aws bedrock`). Foundation models, custom models, fine-tuning, guardrails, inference profiles, agents, knowledge bases, prompts, flows, RAG, model invocation."
---
