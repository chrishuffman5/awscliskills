---
name: aws-pinpoint
description: "Pinpoint via AWS CLI v2 (`aws pinpoint`). Customer engagement campaigns, journeys, segments, messaging channels, templates, endpoints, SMS/voice v2 phone numbers, pools, registrations."
---
