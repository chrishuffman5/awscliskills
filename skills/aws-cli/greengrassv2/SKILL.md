---
name: aws-greengrassv2
description: "Greengrass v2 via AWS CLI v2 (`aws greengrassv2`). Core devices, components, deployments, client device associations, service role management."
---
