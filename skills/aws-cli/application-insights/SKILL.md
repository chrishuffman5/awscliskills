---
name: aws-application-insights
description: "Application Insights via AWS CLI v2 (`aws application-insights`). Applications, components, log patterns, problems, workloads."
---
