---
name: aws-configservice
description: "Config via AWS CLI v2 (`aws configservice`). Config rules, conformance packs, recorders, delivery channels, remediation, aggregators, resource evaluation."
---
