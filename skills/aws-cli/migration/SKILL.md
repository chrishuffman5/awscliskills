---
name: aws-migration
description: "Migration via AWS CLI v2 (`aws migration`). MGN source servers, replication, launch config, cutover, waves, applications, connectors, actions, jobs, import/export, Migration Hub Config, Migration Hub Orchestrator workflows/steps/templates."
---
