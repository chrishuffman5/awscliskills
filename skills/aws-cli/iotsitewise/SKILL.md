...
description: "IoT SiteWise via AWS CLI v2 (`aws iotsitewise`). Asset models, assets, portals, dashboards, gateways, projects, time series data, bulk import, datasets."
---
