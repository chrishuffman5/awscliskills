...
description: "IoT Wireless via AWS CLI v2 (`aws iotwireless`). LoRaWAN/Sidewalk devices, wireless gateways, destinations, multicast groups, FUOTA tasks, network analyzer."
---
