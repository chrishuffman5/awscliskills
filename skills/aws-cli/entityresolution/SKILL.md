...
description: "Entity Resolution via AWS CLI v2 (`aws entityresolution`). Entity matching workflows, ID mapping, ID namespaces, schema mappings, provider services."
---
