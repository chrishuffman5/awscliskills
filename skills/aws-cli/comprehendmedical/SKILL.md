...
description: "Comprehend Medical via AWS CLI v2 (`aws comprehendmedical`). Medical entity detection, PHI detection, ICD-10-CM/RxNorm/SNOMED CT code inference, batch processing."
---
