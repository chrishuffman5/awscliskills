---
name: aws-chime
description: "Chime SDK via AWS CLI v2 (`aws chime`). App instances, meetings, attendees, messaging channels, voice connectors, phone numbers, SIP, proxy sessions, voice profiles."
---
