---
name: aws-resourcegroupstaggingapi
description: "Resource Groups Tagging API via AWS CLI v2 (`aws resourcegroupstaggingapi`). Cross-service tag management, resource discovery by tag, tag compliance reporting."
---
