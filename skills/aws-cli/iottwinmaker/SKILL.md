...
description: "IoT TwinMaker via AWS CLI v2 (`aws iottwinmaker`). Workspaces, entities, component types, scenes, sync jobs, metadata transfer, property values, pricing."
---
