...
description: "Route 53 Resolver via AWS CLI v2 (`aws route53resolver`). Resolver endpoints, forwarding rules, DNS Firewall, query logging, DNSSEC, Outpost Resolvers, Route 53 Profiles."
---
