---
name: aws-fsx
description: "FSx via AWS CLI v2 (`aws fsx`). File systems (Windows/Lustre/ONTAP/OpenZFS), backups, volumes, snapshots, storage virtual machines, data repository, file caches."
---
